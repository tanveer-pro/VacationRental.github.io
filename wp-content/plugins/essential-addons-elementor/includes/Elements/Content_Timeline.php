...
//                    'eael_content_timeline_tab_caret_show' => 'yes',
	...
	protected function dynamic_content_manager( $post_ID, $settings )
	{
		...
		$circle_icon = (isset($settings['__fa4_migrated']['eael_content_timeline_circle_icon_new']) || empty($settings['eael_content_timeline_circle_icon']) ? $settings['eael_content_timeline_circle_icon_new']['value'] : $settings['eael_content_timeline_circle_icon']);
